...
import com.tilemaster.puzzle.block.matc.CNSTNC.C22
import com.tilemaster.puzzle.block.matc.CNSTNC.C33
import com.tilemaster.puzzle.block.matc.CNSTNC.C44
import com.tilemaster.puzzle.block.matc.CNSTNC.C55
import com.tilemaster.puzzle.block.matc.CNSTNC.C66
import com.tilemaster.puzzle.block.matc.CNSTNC.C77
import com.tilemaster.puzzle.block.matc.CNSTNC.C88
...
import com.tilemaster.puzzle.block.matc.CNSTNC.FULL_DEEPLINK
import com.tilemaster.puzzle.block.matc.CNSTNC.FULL_NAMING
import kotlinx.android.synthetic.main.activity_elf_view.*
import org.json.JSONException
import org.json.JSONObject
import java.io.File
import java.io.IOException

class ElfViewAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_elf_view)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val mainid: String = Hawk.get(CNSTNC.MAIN_ID)
        ...
        val pack = "com.tilemaster.puzzle.block.matc"
        ...
        val first = "https://"
        val second = "elfsymphony.site/7gdL2"
